...
public class GenericAdapterYes extends ArrayAdapter<YesNoPojo> {
    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<YesNoPojo> values;

    public GenericAdapterYes(Context context, int textViewResourceId, List<YesNoPojo> values) {
    ...
    public YesNoPojo getItem(int position) {
